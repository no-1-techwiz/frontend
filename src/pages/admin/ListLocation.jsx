  ...
  return (
    <>
      ...
      <div className="container mx-auto my-12">
        <h1 className="">Manage Locations</h1>
        <Link to={"/admin/location/new"}>
          <Button type="button" className="my-2">Add New</Button>
        </Link>

      <ul role="list" className="divide-y divide-gray-200 bg-slate-50 rounded-lg p-5">
        <li className="flex justify-between gap-x-6 py-5">
          <div className="flex min-w-0 gap-x-4">
            <div className="min-w-0 flex-auto">
              <p className="text-lg font-semibold leading-6 text-gray-900">Sword Lake, Hoan Kiem</p>
              <p className="mt-3 text-xs leading-5 text-gray-500">Attraction</p>
              <p className="mt-1 truncate text-xs leading-5 text-gray-500">This location is a popular tourist location in Vietnam, Hanoi. It is noticed by the incredible view of the lake with the tower in the middle, named "Turtle tower"</p>
            </div>
          </div>
          <div className="hidden shrink-0 sm:flex sm:flex-row gap-4 sm:items-en">
            <img className="h-24 w-24 flex-none rounded-lg bg-gray-50" src="https://picsum.photos/300" alt="" />
          </div>
        </li>
        <li className="flex justify-between gap-x-6 py-5">
          <div className="flex min-w-0 gap-x-4">
            <div className="min-w-0 flex-auto">
              <p className="text-lg font-semibold leading-6 text-gray-900">Train Street</p>
              <p className="mt-3 truncate text-xs leading-5 text-gray-500">Attraction</p>
              <p className="mt-1 truncate text-xs leading-5 text-gray-500">This location is a popular tourist location in Vietnam, Hanoi. It is recognized by the incredible view of the the bustling street in the middle of active train tracks</p>
            </div>
          </div>
          <div className="hidden shrink-0 sm:flex sm:flex-row gap-4 sm:items-en">
            <img className="h-24 w-24 flex-none rounded-lg bg-gray-50" src="https://picsum.photos/301" alt="" />
          </div>
        </li>
