...
export const HomePage = () => {
    return (<div className="home-page">
        <div className="banner-home">
            <div className='content-banner'>
                <div className="relative main-banner">
                    ...
                    <p>Organize flights & hotels and map your trips in a free travel app designed for vacation
                        planning & road trips, powered by AI and Google Maps.</p>
                    <AddTripModal>
                        <a className="absolute z-[200]" href="#">Start planning</a>
                    </AddTripModal>
                </div>
                            ...
                            <div className='content-comment'>
                                <div className='item-comment'>
                                    ...
                                    <div className='text-comment'>
                                        <p>I'm a rather extensive planner when I take trips so this was great. I
                                            liked how it auto-filled all of my travel information from my email
                                            account.</p>
                                    </div>
                                    <div className='avatar-comment'>
                                        <img
                                            src="https://itin-strapi.sfo2.digitaloceanspaces.com/Josh_M_1fe508b124.jpg"
                                            alt=""/>
                                        <p>Josh M.</p>
                                    </div>
                                </div>
                                <div className='item-comment'>
                                    ...
                                    <div className='text-comment'>
                                        <p>It left me speechless that I can add places to my trip and they get
                                            automatically populated with a featured pic and description from the
                                            web.</p>
                                    </div>
                                    <div className='avatar-comment'>
                                        <img
                                            src="https://itin-strapi.sfo2.digitaloceanspaces.com/Jorge_D_ca03cc6416.jpg"
                                            alt=""/>
                                        <p>Jorge D.</p>
                                    </div>
                                </div>
                                <div className='item-comment'>
                                    ...
                                    <div className='text-comment'>
                                        <p>Very intuitive and simple while still providing a bunch of features, like
                                            photos on the destinations, descriptions and suggestions for nearby
                                            places to visit.</p>
                                    </div>
                                    <div className='avatar-comment'>
                                        <img
                                            src="https://lh3.googleusercontent.com/a/ACg8ocIzqQ19ir0k76gV7coc8okWYZyIX_1plH6LfJcJY8wzct7wQx8=s96-c-rg-br100"
                                            alt=""/>
                                        <p>Jorge D.</p>
                                    </div>
                                </div>
                                <div className='item-comment'>
                                    ...
                                    <div className='text-comment'>
                                        <p>I’ve been dreaming of a tool like this for years and finally it’s here!
                                            Wanderlog is my new go-to tool after decades of professional travel.</p>
                                    </div>
                                    <div className='avatar-comment'>
                                        <img
                                            src="https://lh3.googleusercontent.com/a/ACg8ocLylRaYGsOxVeFfFWN6BtIJhUF8BML4N2MCWoHmlFWZv3-wnJo=s96-c-rg-br100"
                                            alt=""/>
                                        <p>Jonwick D.</p>
                                    </div>
                                </div>
                        ...
                        <div class="carousel-item">
                            <div className='content-comment'>
                                ...
                                <div className='item-comment'>
                                    ...
                                    <div className='text-comment'>
                                        <p>I really like how user friendly it is and the auto-save. I also enjoy
                                            being able to look at trips that others have planned for
                                            inspiration.</p>
                                    </div>
                                    <div className='avatar-comment'>
                                        <img
                                            src="https://itin-strapi.sfo2.digitaloceanspaces.com/Inside_The_Travel_Lab_d1ecc97dc7.jpg"
                                            alt=""/>
                                        <p>Dasha S.</p>
                                    </div>
                                </div>
                                <div className='item-comment'>
                                    ...
                                    <div className='text-comment'>
                                        <p>Planning your trip by having all the attractions already plugged into a
                                            map makes trip planning so much easier.</p>
                                    </div>
                                    <div className='avatar-comment'>
                                        <img
                                            src="https://itin-strapi.sfo2.digitaloceanspaces.com/Couple_Travel_The_World_8cd99ff8e1.jpg"
                                            alt=""/>
                                        <p>Nadia</p>
                                    </div>
                                </div>
                                <div className='item-comment'>
                                    ...
                                    <div className='text-comment'>
                                        <p>Yesterday I walked my kids through the vacation timeline that I've built
                                            so far and their excitement levels went way up!</p>
                                    </div>
                                    <div className='avatar-comment'>
                                        <img
                                            src="https://itin-strapi.sfo2.digitaloceanspaces.com/Kelvin_S_09c480af0c.jpg"
                                            alt=""/>
                                        <p>Kelvin S .</p>
                                    </div>
                                </div>
        ...
        <div className='plane-pro'>
            ...
            <p>Unlock premium features like offline access, unlimited attachments, flight deals, export to Google
                maps, and <span><a href="">much more</a></span></p>
            <div className='main-feature'>
                <div className='item-main-feature'>
